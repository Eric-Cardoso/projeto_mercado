...
from schemas.schema_usuario import AtualizarUsuario, CriarUsuario


def criar_usuario(usuario: CriarUsuario, sessao: Session) -> Usuario:
...
def atualizar_dados(
    dados: AtualizarUsuario, usuario: Usuario, sessao: Session
) -> Usuario:
