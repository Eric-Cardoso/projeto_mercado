...
from repos import repo_carrinho, repo_produtos, repo_usuario
from schemas import schema_admin, schema_carrinho, schema_produto
from services import produtos_service


def obter_usuario(
    id_usuario: int, usuario: Usuario, sessao: Session
) -> Usuario:
...
def listar_produto(
    id_usuario: int, id_produto: int, usuario: Usuario, sessao: Session
) -> Produto:
...
def listar_produtos(
    id_usuario: int, usuario: Usuario, sessao: Session, offset: int, limit: int
